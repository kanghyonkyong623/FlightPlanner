...
class WorkspaceMngForm(QDialog):
    ...
    def setFullName(self):
        ...
        index = AirCraftOperation.g_projectList.GetIndexOfWsOrProcedure(enumProjectType.ptSubProject,
        ...
        self.textFullName.Value = self.comboProjectWorkspace.SelectedItem + "_" + self.comboSubProjectWorkspace.SelectedItem + "_" + self.textNameWorkspace.Text

        self.textPathWorkspace.Value = projPath + "/" + self.textNameWorkspace.Value
    ...
    def listBoxWorkspace_SelectedIndexChanged(self):
        if (self.listBoxWorkspace.SelectedIndex < 0):
            return
        pi = AirCraftOperation.g_projectList.GetIndexOfWsOrProcedure(enumProjectType.ptWorkspace,
                                                                     self.comboProjectWorkspace.SelectedItem,
                                                                     self.comboSubProjectWorkspace.SelectedItem,
                                                                     self.listBoxWorkspace.Items[self.listBoxWorkspace.SelectedIndex])
    ...
    def buttonModifyWorkspace_Click(self):
        ...
        AirCraftOperation.g_projectList.ProjectsList[index].WorkspaceName = self.textNameWorkspace.Text
    ...
    def comboProjectWorkspace_SelectedIndexChanged(self):
        ...
        self.editFlag = False
        self.comboSubProjectWorkspace_SelectedIndexChanged()

    def comboSubProjectWorkspace_SelectedIndexChanged(self):
        if self.editFlag:
            return
        listWorkspaceList = AirCraftOperation.g_projectList.GetListOfWsOrProcedure(enumProjectType.ptWorkspace, self.comboProjectWorkspace.SelectedItem, self.comboSubProjectWorkspace.SelectedItem)
        self.textNameWorkspace.Text = ""
        self.listBoxWorkspace.Clear()
        self.editFlag = True
        if len(listWorkspaceList) > 0:
            self.listBoxWorkspace.Items = listWorkspaceList
            self.listBoxWorkspace.SelectedIndex = 0
        self.editFlag = False
        self.setFullName()