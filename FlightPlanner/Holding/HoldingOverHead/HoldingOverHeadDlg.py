...
from PyQt4.QtCore import SIGNAL, QCoreApplication, QString
...
from FlightPlanner.types import CriticalObstacleType, ObstacleTableColumnType, SurfaceTypes, DistanceUnits, OrientationType, ObstacleAreaResult
